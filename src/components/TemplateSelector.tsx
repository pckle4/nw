    ...
    <div className="space-y-8 animate-fade-in">
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <div className="flex gap-2 items-center justify-center mt-4">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-resume-purple text-white">1</div>
        ...
        <Carousel className="w-full">
          <CarouselContent>
            {templates.map((template) => (
              <CarouselItem key={template.id} className="md:basis-1/3 lg:basis-1/4">
                <div 
      ...
      <div className="flex justify-center mt-6">
        <Button 
          ...
          className="px-6 py-5 text-base flex items-center gap-2 rounded-xl shadow-md hover:shadow-lg transition-all"
        >
      ...
      <div className="bg-gray-50 py-8 mt-8 rounded-xl">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Why Choose ColorBurst Resume?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Download your resume as a PDF immediately after completing your information</p>
            </div>
          </div>
        </div>
      </div>
